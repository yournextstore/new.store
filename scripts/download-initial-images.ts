...
const imageData = {
  images: [
    {
      imageUrl:
        'https://fpvnqhp6jqce9ax6.public.blob.vercel-storage.com/images/019610fa-22f5-7637-bb96-aae581db5744/test/image-rcnmRcA1JDoTyqrWeT9zegZLPQR9qX.png',
    ...
    {
      imageUrl:
        'https://fpvnqhp6jqce9ax6.public.blob.vercel-storage.com/images/019610fa-22f5-7637-bb96-aae581db5744/test/image-qbZkaBag6P1VyXpBsgXetjiRiJRqe7.png',
    ...
    {
      imageUrl:
        'https://fpvnqhp6jqce9ax6.public.blob.vercel-storage.com/images/019610fa-22f5-7637-bb96-aae581db5744/test/image-mH7DdOrR1rceRbBTfZXrUMVzrnDDpq.png',
    ...
    {
      imageUrl:
        'https://jtit1h3gvnocbut8.public.blob.vercel-storage.com/images/01948eb4-7b77-70dc-85a2-c3c17a30a3c2/test/quark-gray-hseSkBXrgs887NXdCHUL5EJP7hQfPs.png?w=3840&q=75',
    ...
    {
      imageUrl:
        'https://fpvnqhp6jqce9ax6.public.blob.vercel-storage.com/images/019610fa-22f5-7637-bb96-aae581db5744/test/image-CX8Ea6LapzoRsdKhI6h6h7vNwb3hH6.png',
    ...
    {
      imageUrl:
        'https://fpvnqhp6jqce9ax6.public.blob.vercel-storage.com/images/019610fa-22f5-7637-bb96-aae581db5744/test/image-saLKXICaYWchH844KPnPuZArnEG2wc.png',
...
async function main() {
  ...
  for (const image of imageData.images) {
    try {
      const fileExtension =
        path.extname(new URL(image.imageUrl).pathname) || '.png'; // Default to .png if no extension
      ...
      console.log(
        `Downloading ${image.shortName} from ${image.imageUrl} to ${destinationPath}...`,
      );
      ...
      console.error(
        `Error downloading ${image.shortName} (${image.imageUrl}):`,
        error,
      );
